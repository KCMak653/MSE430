def tunnel(barrier_height, barrier_width):
    """
...
#     """
    ...
    class Schrodinger(object):
        ...
        def time_step(self, dt, Nsteps=1):
            ...
            if Nsteps > 0:
                ...
                for num_iter in range(Nsteps - 1): #X: xrange -> range (python3)
                    self.compute_k_from_x()
    ...
    #make sure barrier height and width are good
    assert barrier_height > 0
    assert barrier_width > 0 
    assert barrier_width < 60
    ######################################################################
    ...
    # specify potential
    V0 = barrier_height #Barrier height
    ...
    anim = animation.FuncAnimation(fig, animate, init_func=init,
                                   frames=frames, interval=30, blit=False, repeat=True)
    plt.close()
    print('Loading...')
